...
var ServerStub = function () {
	...
	var memberData = [
	                  {	userName: "john.citizen",
		                ...
		                {	userName: "mark.person",
	                		data: {  
								personal: {		firstName: "Mark", lastName: "Person", 
												address: { 	street: "1 Main Street", city: "Melbourne", postCode: 3000, country: "Australia" }, 
												phoneNumber: 0399998888, emailAddress: "mark.dude@email.com"},
								accounts: [
								           ...
								           {	summary: {branch: "Doncaster", number: "0612 63772", type: "Cheque", balance: 10000}, 
												transactions: [{date: "21 June", description: "Black coder coffee on the run", category: "Food", amount: 53}]
								           }			           
								          ]
			                		}
		                	}	                	
	...
	var constuctToken = function (user) {
		var date = new Date();
		var payload = { iss: "mybank", exp: date.getTime(), sub: "authentication token", 
